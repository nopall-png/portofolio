...
export default function Certificates() {
  // State untuk mengontrol apakah semua sertifikat ditampilkan
  const [showAll, setShowAll] = useState(false);

  // Batas jumlah sertifikat awal yang ingin ditampilkan
  const initialDisplayCount = 2;

  // Menentukan sertifikat yang akan di-render
