...
export const aboutMe = {
  text: "AI is where my curiosity meets my career. I love diving deep into Machine Learning and Deep Learning to build solutions that matter, with a special focus on the transformative power of Computer Vision. However, I don't just stop at the code. I am also a creator at heart who loves the art of UI/UX, ensuring digital experiences are seamless, and I enjoy the process of poster design to bring creative concepts to life.",
  stats: [
...
export const services = [
  ...
  },
  {
    id: "03",
    title: "UI/UX Design",
    description: "Crafting intuitive user interfaces with attention to aesthetics and user experience. Every pixel is designed with purpose to create delightful interactions."
  },
  {
    id: "04",
    title: "Mobile Development",
    description: "Creating seamless cross-platform mobile experiences with responsive design principles. Native performance meets beautiful design."
  }
];
